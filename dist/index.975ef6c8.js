...
parcelHelpers.export(exports, "PHOTOS_PER_PAGE", ()=>PHOTOS_PER_PAGE);
var _notiflix = require("notiflix");
var _fetchPhotos = require("./scripts/fetchPhotos");
var _createPhotoMarkup = require("./scripts/createPhotoMarkup");
...
let pageNum = 1;
let currentWord = "";
let galleryLightBox = new (0, _simplelightboxDefault.default)(".gallery a", {
    showCounter: false
});
searchForm.addEventListener("submit", async (e)=>{
    ...
    window.scroll(0, 0);
    const data = await (0, _fetchPhotos.fetchPhotos)(currentWord);
    gallery.innerHTML = "";
    if (data.hits.length === 0) {
        (0, _notiflix.Notify).failure("Sorry, there are no images matching your search query. Please try again.");
        return;
    }
    (0, _notiflix.Notify).info(`Hooray! We found ${data.totalHits} images.`);
    data.hits.forEach((photo)=>{
        gallery.insertAdjacentHTML("beforeend", (0, _createPhotoMarkup.createPhotoMarkup)(photo));
    });
    galleryLightBox.refresh();
});
const infiniteScrollGuard = (0, _lodash.debounce)(infiniteScroll, 400);
...
async function infiniteScroll() {
    ...
    if (window.scrollY + 1.25 * window.innerHeight >= document.documentElement.scrollHeight) {
        pageNum++;
        const data = await (0, _fetchPhotos.fetchPhotos)(searchQuery.value, pageNum);
        data.hits.forEach((photo)=>{
            gallery.insertAdjacentHTML("beforeend", (0, _createPhotoMarkup.createPhotoMarkup)(photo));
        });
        galleryLightBox.refresh();
        if (pageNum * PHOTOS_PER_PAGE >= data.totalHits) {
            (0, _notiflix.Notify).info("We're sorry, but you've reached the end of search results.");
            window.removeEventListener("scroll", infiniteScrollGuard);
        }
    }
}

},{"notiflix":"5z0Oc","./scripts/fetchPhotos":"b1em7","./scripts/createPhotoMarkup":"aEPNr","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash":"3qBDj"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"b1em7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function fetchPhotos(name, page = 1) {
    try {
        const request = await (0, _axiosDefault.default).get(`https://pixabay.com/api/?key=34392060-359edd6d0360047c3a2486bc3&image_type=photo&orientation=horizontal&safesearch=true&per_page=${(0, _index.PHOTOS_PER_PAGE)}&q=${name}&page=${page}`);
        return request.data;
    } catch (err) {
        (0, _notiflix.Notify).failure("ERROR", err);
    }
}

},{"axios":"jo6P5","notiflix":"5z0Oc","../index":"8lqZg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var Buffer = require("188f41f37299e9f6").Buffer;
"use strict";
/**
...
},{"188f41f37299e9f6":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("c5e831beb0b37ad8");
var ieee754 = require("505b356c7ae50b64");
...
},{"c5e831beb0b37ad8":"eIiSV","505b356c7ae50b64":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aEPNr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createPhotoMarkup", ()=>createPhotoMarkup);
function createPhotoMarkup({ likes , views , comments , downloads , webformatURL , tags , largeImageURL  }) {
    return `
...
},{}],"kaxSc":[function() {},{}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
